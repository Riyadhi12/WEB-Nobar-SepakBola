    ...
    <section>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="aksi">
                                                ...
                                                <a href="hapus_agenda.php?id=<?php echo $data['id']; ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="aksi">
                                                ...
                                                <a href="batal_agenda.php?id_diikuti=<?php echo $data['id_diikuti']; ?>">
        ...
        <div class="notif-hapus">
            <div class="kotak-notif">
                <h4>YAKIN INGIN MEMBATALKAN AGENDA ??</h4>
                <div class="aksi">
                    <a href="akun.php">
                        <div class="kembali">
                            <p>KEMBALI</p>
                    ...
                    ?>
                    <a href="batal_agenda.php?id_diikuti=<?php echo $id_diikuti ?>">
                        <div class="hapus">
                            <p>BATALKAN</p>
                        </div>
                    </a>
